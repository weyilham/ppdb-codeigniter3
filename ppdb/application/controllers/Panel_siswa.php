...
public function uploadBerkas(){
	$data['siswa'] = $this->db->get_where('tbl_siswa', ['no_pendaftaran' => $this->session->userdata('no_pendaftaran')])->row_array();
	...
	$skhun = $this->upload->data('file_name');
	$this->upload->do_upload('kk');
	$kk = $this->upload->data('file_name');
	$this->upload->do_upload('nisn');
	$nisn = $this->upload->data('file_name');

	$no_anggota = $this->session->userdata('no_pendaftaran');
	...
	$data = json_encode($dataUpload);
	// var_dump($data);die;
	// var_dump($data);die;

	$this->db->set('dokumen', $data);
