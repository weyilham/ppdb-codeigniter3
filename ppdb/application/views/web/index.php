...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">
                    <img src="img/logo1.png" alt="Logo" width="35" style="position:absolute;margin-top:-10px;">
    ...
    <header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="img/logo1.png" style="margin-top:-15%;margin-bottom:-10px;" width="100">
                    <br><br>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12" style="margin-top:-10px;">
                    ...
                    <div class="col-md-8">
                        <img class="img-responsive" src="img/alur1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12" style="margin-top:-10px;">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <img class="img-responsive" src="img/syarat1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
