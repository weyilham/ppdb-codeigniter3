			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="img/logo1.png" alt="foto">
				...
				<div class=" sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible" style="background-color: white;">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_siswa/biodata" class="media-left"><img src="img/logo1.png" class="img-flat img-sm" alt="foto"></a>
							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if ($menu == 'panel_siswa' and $sub_menu == 'biodata') {
											...
											<li class="<?php if ($menu == 'panel_siswa' and $sub_menu == 'berkas') {
															echo 'active';
														} ?>"><a href="panel_siswa/berkas/"><i class="icon-file-check2"></i> <span><b>UPLOAD BERKAS</b></span></a></li>
